...
_ASSETS_BASE_URL = os.getenv("ULTRALYTICS_ASSETS_URL", "https://github.com/ultralytics/assets/releases/download")
ASSETS_URL = f"{_ASSETS_BASE_URL}/v0.0.0"  # assets GitHub URL
